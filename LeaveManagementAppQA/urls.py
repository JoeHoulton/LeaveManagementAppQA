...
urlpatterns = patterns('',
    ...
    url(r'^account/organisationinformation/','LeaveManagementAppQA.accounts.views.get_user_organisation_and_team'),
    url(r'^account/leavedetails/','LeaveManagementAppQA.accounts.views.get_leave_information_ajax'),
    url(r'^account/editaddress/','LeaveManagementAppQA.accounts.views.edit_address'),
